...
public class StoryManager : MonoBehaviour
{
    ...
    private void LoadStoryData()
    {
        ...
        // とりあえずテスト用にハードコードで追加
        storyDataList.Add(new StoryData() { Name = "キャラA", Talk = "今日はいい天気ですね。", Left = "Sprites/CharA" });
        storyDataList.Add(new StoryData() { Name = "キャラB", Talk = "本当にそうですね。", Right = "Sprites/CharB" });
    }
